...
func NewLoadBalancer(clusterNS string, kcfg *rest.Config, ownerRef *metav1.OwnerReference, svcAnnoPropEnabled bool) (cloudprovider.LoadBalancer, error) {
	...
	vmService := vmservice.NewVMService(client, clusterNS, ownerRef, svcAnnoPropEnabled)
	return &loadBalancer{
		vmService: vmService,
	}, nil
}
